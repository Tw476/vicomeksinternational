      ...
      <section className="grid gap-8 rounded-lg bg-white p-8 shadow-premium md:grid-cols-[1fr_.9fr] md:p-12">
        <div>
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row">
            ...
            <a href={`tel:${businessPhone.replace(/\s/g, "")}`} className="gold-ring inline-flex items-center justify-center gap-2 rounded-md border border-black/15 px-6 py-4 text-sm font-semibold hover:border-gold hover:bg-champagne">
              <Phone size={17} /> Call {businessPhone}
            </a>
          </div>
        </div>
        <div className="rounded-lg border border-black/10 bg-[#faf8f2] p-6">
